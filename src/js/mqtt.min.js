  ...
  })()(
    {
          ...
          (function (r, n) {
            (function () {
              ...
              function E(e, t, r, n) {
                ...
                let i,
                  o = t;
                if ("publish" === o.cmd && ((o = p(t)), (i = k(e, o))))
                  return r && r(i);
                ...
                y("MqttClient :: options.protocol", t.protocol),
                  ...
                  t.topicAliasMaximum > 0 &&
                    (t.topicAliasMaximum > 65535
                      ...
                      : (this.topicAliasRecv = new s(t.topicAliasMaximum))),
              ...
              h(T, i),
                        ...
                        (t = e.outgoing) &&
                          ...
                          Object.keys(t).forEach(function (e) {
                            t[e].volatile &&
                              ...
                              (t[e].cb(new Error("Connection closed")),
                              delete t[e]);
                          })),
                ...
                (T.prototype.subscribe = function () {
                  ...
                  delete n.resubscribe,
                    "string" == typeof n && (n = [n]),
                    "function" != typeof o && ((s = o), (o = C));
                  const l = d.validateTopics(n);
                  if (null !== l)
                    return m(o, new Error("Invalid topic " + l)), this;
                      ...
                      : Object.keys(n).forEach(function (t) {
                          if (
                            ...
                            !Object.prototype.hasOwnProperty.call(
                              ...
                              e._resubscribeTopics[t].qos < n[t].qos ||
                              i)
                          ) {
                ...
                (T.prototype.unsubscribe = function () {
                  ...
                  let r = t.shift(),
                    ...
                    i = t.pop();
                  "string" == typeof r && (r = [r]),
                    "function" != typeof n && ((i = n), (n = C));
                  const o = d.validateTopics(r);
                  if (null !== o)
                    return m(n, new Error("Invalid topic " + o)), this;
                ...
                (T.prototype._cleanUp = function (e, t) {
                  ...
                  if (
                    ...
                    0 === this.options.reconnectPeriod &&
                      ...
                      Object.keys(n).forEach(function (e) {
                        "function" == typeof n[e].cb &&
                          (n[e].cb(new Error("Connection closed")),
                          delete n[e]);
                      })),
                      y(
                    ...
                    y(
                      ...
                      this._sendPacket(
                        e,
                        m.bind(null, this.stream.end.bind(this.stream))
                      );
                  }
                  var n;
                  this.disconnecting ||
                ...
                (T.prototype._sendPacket = function (e, t, r) {
                  ...
                  if (n) t(n);
                    ...
                    if (!this.connected)
                      return "auth" === e.cmd
                        ? (this._shiftPingInterval(), void S(this, e, t))
                        : (y(
                    ...
                    switch ((y("_handleAck :: packet type", r), r)) {
                      ...
                      case "puback": {
                        ...
                        r &&
                          r > 0 &&
                          16 !== r &&
                          (((s = new Error("Publish error: " + _[r])).code = r),
                          i(s, e)),
                      ...
                      case "pubrec": {
                        ...
                        const r = e.reasonCode;
                        r && r > 0 && 16 !== r
                          ? (((s = new Error("Publish error: " + _[r])).code =
                              r),
                            i(s, e))
                          : this._sendPacket(n);
                        break;
                        ...
                        (function e() {
                          ...
                          r
                            ? t._packetIdsDuringStoreProcessing[r.messageId]
                              ...
                              ? n.destroy && n.destroy()
                              : ((i = t.outgoing[r.messageId]
                                  ? t.outgoing[r.messageId].cb
                                  : null),
                                ...
                                t.messageIdProvider.register(r.messageId)
                                  ? t._sendPacket(r)
                                  : y(
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      d
                        ...
                        : ((f.onclose = y), (f.onerror = b), (f.onmessage = m)),
                      r
                    );
                  }
                : function (e, t) {
        ...
        function (e, t, r) {
          ...
          (o.prototype.put = function (e, t) {
            ...
            (o.prototype.getLruAlias = function () {
              ...
              return (
                e || this.aliasToTopic.keys()[this.aliasToTopic.length - 1]
              );
            }),
            (t.exports = o);
        },
            ...
            (function () {
              ...
              function u(e, t) {
                ...
                if (
                  ...
                  if (
                    -1 === ["mqtts", "wss", "wxs", "alis"].indexOf(t.protocol)
                  )
                    switch (t.protocol) {
                      case "mqtt":
                        t.protocol = "mqtts";
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += s + h >= 1 ? f / l : f * Math.pow(2, 1 - h)) * l >=
                        2 && (s++, (l /= 2)),
                      s + h >= c
                        ? ((a = 0), (s = c))
                        : s + h >= 1
          ...
          function i(e) {
              ...
              (this.forEach = function (e) {
                if (!this.empty()) {
                  ...
                  if (o !== a) {
                    ...
                    for (u = o + 1; u < a; ++u)
                      for (var n = 0; n < i.bucketSize; ++n) e(r[u][n], t++);
            ...
            var f = function (e) {
              for (
                var t = [],
                  n = e * i.sigma,
                  h = Math.max(Math.ceil(n / i.bucketSize), 2),
                  f = 0;
                f < h;
                ++f
              )
            ...
            (this.pushBack = function (e) {
              this.empty() ||
                ...
                l < i.bucketSize - 1 ? ++l : a < u - 1 && (++a, (l = 0))),
                ++c,
                (r[a][l] = e);
            }),
              ...
              (this.pushFront = function (e) {
                this.empty() ||
                  (0 === o && 0 === s && f.call(this, this.size()),
                  s > 0 ? --s : o > 0 && (--o, (s = i.bucketSize - 1))),
                  ++c,
                  (r[o][s] = e);
              }),
                      ...
                      if (!n.empty()) {
                        if (n instanceof s.default && 1 === n.size()) {
                          ...
                          n.forEach(function (t) {
                            ...
                            u.size() > a.untreeifyThreshold
                              ? (t[i] = new o.default(u))
                              : u.size() && (t[i] = u),
                            f.size() > a.untreeifyThreshold
                              ? (t[i + e] = new o.default(f))
                              : f.size() && (t[i + e] = f);
                        } else {
                          var p = new s.default(),
                            d = new s.default();
          ...
          function o(e) {
            ...
            (this.size = function () {
              ...
              (this.insert = function (e, t, n) {
                if ((void 0 === n && (n = 1), null === t || void 0 === t))
          ...
          function s(e, t) {
            ...
            var c = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value) {
                ...
                return 0 === n
                  ...
                  : n < 0
                  ? c(e.rightChild, r)
                  : c(e.leftChild, r) || { key: e.key, value: e.value };
              }
            };
            ...
            var h = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value)
                return t(e.key, r) <= 0
                  ? h(e.rightChild, r)
                  : h(e.leftChild, r) || { key: e.key, value: e.value };
            };
            ...
            var f = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value) {
                ...
                return 0 === n
                  ...
                  : n > 0
                  ? f(e.leftChild, r)
                  : f(e.rightChild, r) || { key: e.key, value: e.value };
              }
            };
            ...
            var p = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value)
                return t(e.key, r) >= 0
                  ? p(e.leftChild, r)
                  : p(e.rightChild, r) || { key: e.key, value: e.value };
            };
            ...
            var d = function (e) {
                ...
                if (e.color !== o.default.TreeNodeColorType.red) {
                  ...
                  if (e === t.leftChild) {
                    if (r.color === o.default.TreeNodeColorType.red) {
                      ...
                      if (
                        r.rightChild &&
                        r.rightChild.color === o.default.TreeNodeColorType.red
                      ) {
                        (r.color = t.color),
                        ...
                        (r.rightChild &&
                          r.rightChild.color !==
                            o.default.TreeNodeColorType.black) ||
                        !r.leftChild ||
                        r.leftChild.color !== o.default.TreeNodeColorType.red
                      )
                        (r.leftChild &&
                          r.leftChild.color !==
                            o.default.TreeNodeColorType.black) ||
                          (r.rightChild &&
                            r.rightChild.color !==
                              o.default.TreeNodeColorType.black) ||
                          ((r.color = o.default.TreeNodeColorType.red), d(t));
                      else {
              ...
              y = function (e, t) {
                return (
                  !(!e || void 0 === e.key) &&
                  (!!y(e.leftChild, t) || !!t(e) || y(e.rightChild, t))
                );
              };
            (this.eraseElementByPos = function (e) {
              if (e < 0 || e >= s)
            ...
            (this.find = function (e) {
              ...
              (this.getElementByKey = function (e) {
                var t = v(a, e);
                if (
                  void 0 === (null === t || void 0 === t ? void 0 : t.key) ||
              ...
              for (var e = Math.floor((n - 1) / 2); e >= 0; --e)
                for (var o = e, s = 2 * o + 1; s < n; ) {
                  var a = s + 1,
                    l = s;
                  if (
                    (a < n && t(r[s], r[a]) > 0 && (l = a), t(r[o], r[l]) <= 0)
                  )
                    break;
                  i(o, l), (s = 2 * (o = l) + 1);
                }
          ...
          function s(e, t) {
            ...
            var c = function (e) {
                      ...
                      if (
                        ...
                        (r.leftChild &&
                          ...
                          (r.rightChild &&
                            r.rightChild.color !==
                              o.default.TreeNodeColorType.black) ||
                          ((r.color = o.default.TreeNodeColorType.red), c(t));
                      else {
                        (r.color = o.default.TreeNodeColorType.red),
                          r.leftChild &&
                            (r.leftChild.color =
              ...
              f = function (e, t) {
                return (
                  !(!e || void 0 === e.key) &&
                  (!!f(e.leftChild, t) || !!t(e) || f(e.rightChild, t))
                );
              };
            (this.eraseElementByPos = function (e) {
              if (e < 0 || e >= s)
          ...
          const g = (e, t, r) => {
              ...
              if (n) {
                ...
                if (y(e, t)) {
                  ...
                  r &&
                    (e[p] && (n.value.now = Date.now()), e[h].unshiftNode(n));
                return t.value;
              }
            },
            y = (e, t) => {
        ...
        function (e, t, r) {
          ...
          class l extends i {
            ...
            _parseConnect() {
              ...
              if (((o.protocolId = l), this._pos >= this._list.length))
            ...
            _parseVarByteNum(e) {
              ...
              for (; r < 4 && l + r < this._list.length; ) {
                if (
                  ((i +=
                    n *
                    ((t = this._list.readUInt8(l + r++)) & s.VARBYTEINT_MASK)),
                  (n *= 128),
          ...
          (function (r) {
            (function () {
              ...
              Object.defineProperty(y, "cacheNumbers", {
                ...
                set(e) {
                  e
                    ? ((u && 0 !== Object.keys(u).length) || (g = !0), (d = k))
                    : ((g = !1), (d = S));
                },
              });
              const m = {};
              ...
              function A(e, t, r) {
                ...
                for (const r in t)
                  if (
                    ...
                    const n = t[r];
                    if (Array.isArray(n))
                      for (let t = 0; t < n.length; t++) x(e, r, n[t]);
                    else x(e, r, n);
                  }
              }
              function I(e) {
          ...
          (s.prototype.equals = function (e) {
            ...
            (a.prototype.alloc = function () {
              ...
              const e = this.ss.front(),
                t = e.low;
              return (
                t + 1 <= e.high ? ++e.low : this.ss.eraseElementByPos(0),
                i("alloc():" + t),
                t
              );
            }),
            ...
            (a.prototype.free = function (e) {
              ...
              if (r) {
                ...
                if (r === this.ss.front())
                  ...
                  n.high + 1 === e
                    ? e + 1 === r.low
                      ? (this.ss.eraseElementByValue(n), (r.low = n.low))
                      : (n.high = e)
                    : e + 1 === r.low
                    ? (r.low = e)
                    : this.ss.insert(t);
              ...
              !(function (n) {
                ...
                function B(e) {
                  var t,
                    ...
                    k = y,
                    E = g;
                  for ((r = e.lastIndexOf(b)) < 0 && (r = 0), n = 0; n < r; ++n)
                ...
                function R(e) {
                  var t,
                    ...
                    T = [];
                  for (
                    v = (e = A(e)).length, t = y, r = 0, o = g, s = 0;
                    s < v;
                    ++s
                  )
                  ...
                  for (n = i = T.length, i && T.push(b); n < v; ) {
                    ...
                    for (
                      ...
                      if (
                        ((m = e[s]) < t && ++r > u && C("overflow"), m == t)
                      ) {
                        for (
                          l = r, p = c;
                          !(l < (d = p <= o ? h : p >= o + f ? f : p - o));
                          p += c
                        )
                          (k = l - d),
                            (_ = c - d),
            ...
            (function () {
              ...
              (C.prototype.read = function (e) {
                ...
                (C.prototype.removeAllListeners = function (e) {
                  ...
                  return (
                    ("readable" !== e && void 0 !== e) || r.nextTick(M, this), t
                  );
                }),
                  ...
                  ? ((c = Function.prototype[Symbol.hasInstance]),
                    Object.defineProperty(C, Symbol.hasInstance, {
                      value: function (e) {
                        return (
                          !!c.call(this, e) ||
                          (this === C && e && e._writableState instanceof E)
                        );
                      },
                    }))
                  : (c = function (e) {
            ...
            (function () {
              ...
              function d(e) {
                ...
                if (null !== t) {
                  var r = e[f].read();
                  null !== r &&
                    ((e[c] = null), (e[s] = null), (e[a] = null), t(p(r, !1)));
                }
              }
          ...
          (function (e) {
            (function () {
              ...
              t.exports = function (e) {
                ...
                function t(e, t) {
                  for (
                    var n = Object.keys(e), i = new Array(n.length), o = 0;
                    o < n.length;
                    o++
                  ) {
                    var s = n[o],
        ...
        function (e, t, r) {
          ...
          (o.prototype.parse = function (e, t, r) {
            ...
            if (!y[_] && (S || (_ && !b[_]))) {
              ...
              -1 !==
                (C = -1 === T ? v.lastIndexOf("@") : v.lastIndexOf("@", T)) &&
                ((E = v.slice(0, C)),
                (v = v.slice(C + 1)),
              ...
              if (!I)
                for (
                  var P = this.hostname.split(/\./), O = ((x = 0), P.length);
                  x < O;
                  x++
                ) {
                  var B = P[x];
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              E &&
                ((r.hostname = r.host = P ? "" : S.length ? S.shift() : ""),
                (I =
      ...
      83: [
        function (e, t, r) {
          ...
          function i(e, t, r) {
            var n =
              t === e.head ? new a(r, null, t, e) : new a(r, t, t.next, e);
            return (
